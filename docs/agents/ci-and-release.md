---
name: ci-and-release
description: CI workflows, the semantic-release model, which commit types ship a release, and the two script directories
globs:
  - .github/workflows/**
  - .releaserc.json
  - scripts/**
...
it. See [`generated-code.md`](generated-code.md).
