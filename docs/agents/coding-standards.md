...
description: Comment rules, CSS why-comments, the writing-style ban list, boolean naming and Storybook titles
globs:
...
see [`jsdoc.md` § Component lifecycle tags](jsdoc.md).
