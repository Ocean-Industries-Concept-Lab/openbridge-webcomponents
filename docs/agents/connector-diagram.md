---
name: connector-diagram
description: Canvas pipe-drawing package — tests, snapshot baselines and the workspace lockfile
globs:
...
among them ([`ci-and-release.md`](ci-and-release.md)).
