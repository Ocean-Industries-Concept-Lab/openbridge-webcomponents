...
description: Integration bar, fleet and vessel selection components built on the shared integration-button primitive
globs:
  - packages/openbridge-webcomponents/src/integration-systems/**
---
...
[`figma-refresh.md` § Icons](figma-refresh.md#icons) names `integration-bar`
