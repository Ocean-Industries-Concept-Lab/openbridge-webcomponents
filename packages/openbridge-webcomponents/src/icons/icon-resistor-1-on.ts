...
<path fill-rule="evenodd" clip-rule="evenodd" d="M20 11V8L4 8V11H1L1 13H4L4 16L20 16V13H23V11H20ZM19 9L5 9L5 15L19 15V9Z" style="fill: var(--automation-device-tertiary-color)"/>
<path fill-rule="evenodd" clip-rule="evenodd" d="M19 9L5 9L5 15L19 15V9Z" style="fill: var(--automation-device-primary-color)"/>
</svg>
`;
