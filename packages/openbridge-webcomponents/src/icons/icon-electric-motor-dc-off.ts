...
@customElement('obi-electric-motor-dc-off')
export class ObiElectricMotorDcOff extends LitElement {
  @property({type: Boolean}) useCssColor = false;

  private icon = svg`<svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
<g clip-path="url(#clip0_11002_2617)">
...
<path d="M17 17.3529V19H7V17.3529H17Z" style="fill: var(--automation-device-tertiary-inverted-color)"/>
</g>
<defs>
<clipPath id="clip0_11002_2617">
...
declare global {
  interface HTMLElementTagNameMap {
    'obi-electric-motor-dc-off': ObiElectricMotorDcOff;
  }
}
