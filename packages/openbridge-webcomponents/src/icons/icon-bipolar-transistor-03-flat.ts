...
@customElement('obi-bipolar-transistor-03-flat')
export class ObiBipolarTransistor03Flat extends LitElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'obi-bipolar-transistor-03-flat': ObiBipolarTransistor03Flat;
  }
}
