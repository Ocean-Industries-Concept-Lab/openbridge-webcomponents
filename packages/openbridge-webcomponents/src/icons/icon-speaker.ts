...
@customElement('obi-speaker')
export class ObiSpeaker extends LitElement {
...
<path d="M6 9V15H10L15 20V4L10 9H6Z" style="fill: var(--automation-device-secondary-color)"/>
</svg>
`;
