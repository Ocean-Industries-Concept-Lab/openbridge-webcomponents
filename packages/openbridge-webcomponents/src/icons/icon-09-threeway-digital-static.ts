...
@customElement('obi-09-threeway-digital-static')
export class Obi09ThreewayDigitalStatic extends LitElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'obi-09-threeway-digital-static': Obi09ThreewayDigitalStatic;
  }
}
