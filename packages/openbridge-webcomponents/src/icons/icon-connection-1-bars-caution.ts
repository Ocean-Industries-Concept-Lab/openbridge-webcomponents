...
@customElement('obi-connection-1-bars-caution')
export class ObiConnection1BarsCaution extends LitElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'obi-connection-1-bars-caution': ObiConnection1BarsCaution;
  }
}
