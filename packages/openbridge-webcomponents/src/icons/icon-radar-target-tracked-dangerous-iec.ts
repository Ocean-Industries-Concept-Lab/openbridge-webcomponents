...
@customElement('obi-radar-target-tracked-dangerous-iec')
export class ObiRadarTargetTrackedDangerousIec extends LitElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'obi-radar-target-tracked-dangerous-iec': ObiRadarTargetTrackedDangerousIec;
  }
}