...
@customElement('obi-own-ship-alternative-filled')
export class ObiOwnShipAlternativeFilled extends LitElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'obi-own-ship-alternative-filled': ObiOwnShipAlternativeFilled;
  }
}
