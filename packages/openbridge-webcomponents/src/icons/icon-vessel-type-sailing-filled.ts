...
@customElement('obi-vessel-type-sailing-filled')
export class ObiVesselTypeSailingFilled extends LitElement {
...
<path d="M16.4219 19.3128L16.0001 21H8.0001L7.57829 19.3128C6.08707 13.3479 7.38118 7.05783 11.0402 2.18358C11.344 1.77897 11.664 1.38411 12.0001 1C12.3362 1.38411 12.6562 1.77897 12.96 2.18358C16.619 7.05783 17.9131 13.3479 16.4219 19.3128Z" style="fill: var(--element-active-inverted-color)"/>
...
declare global {
  interface HTMLElementTagNameMap {
    'obi-vessel-type-sailing-filled': ObiVesselTypeSailingFilled;
  }
}
