...
@customElement('obi-05-screen-split-right')
export class Obi05ScreenSplitRight extends LitElement {
...
<path d="M9 5H20V15H9V5Z" fill="currentColor"/>
<path d="M4 5H8V15H4V5Z" fill="currentColor"/>
</svg>
`;
...
<path d="M9 5H20V15H9V5Z" style="fill: var(--element-active-color)"/>
<path d="M4 5H8V15H4V5Z" style="fill: var(--element-active-color)"/>
</svg>
`;
...
declare global {
  interface HTMLElementTagNameMap {
    'obi-05-screen-split-right': Obi05ScreenSplitRight;
  }
}
