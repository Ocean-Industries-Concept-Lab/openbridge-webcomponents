...
@customElement('obi-radar-target-tracked-selected-iec')
export class ObiRadarTargetTrackedSelectedIec extends LitElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'obi-radar-target-tracked-selected-iec': ObiRadarTargetTrackedSelectedIec;
  }
}