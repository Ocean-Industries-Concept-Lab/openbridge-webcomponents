...
@customElement('obi-18-ais-underwayusingengine')
export class Obi18AisUnderwayusingengine extends LitElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'obi-18-ais-underwayusingengine': Obi18AisUnderwayusingengine;
  }
}
