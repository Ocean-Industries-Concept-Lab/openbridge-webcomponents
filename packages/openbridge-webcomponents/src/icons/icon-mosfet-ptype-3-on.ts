...
@customElement('obi-mosfet-ptype-3-on')
export class ObiMosfetPtype3On extends LitElement {
...
<path d="M23 1L11 1V4.25L23 4.25V1Z" style="fill: var(--automation-device-primary-color)"/>
<path d="M1 1L9 1L9 23H1L1 5.75L4.75 5.75L4.75 19H6.25L6.25 4.25L1 4.25L1 1Z" style="fill: var(--automation-device-primary-color)"/>
<path d="M23 23L11 23V19.75L23 19.75V23Z" style="fill: var(--automation-device-primary-color)"/>
<path d="M23 5.75L23 18.25L11 18.25L11 12.75H13V16L17.875 12.75H20.75L20.75 5.75H23Z" style="fill: var(--automation-device-primary-color)"/>
<path d="M17.875 11.25H19.25V5.75L11 5.75L11 11.25H13V8L17.875 11.25Z" style="fill: var(--automation-device-primary-color)"/>
...
declare global {
  interface HTMLElementTagNameMap {
    'obi-mosfet-ptype-3-on': ObiMosfetPtype3On;
  }
}