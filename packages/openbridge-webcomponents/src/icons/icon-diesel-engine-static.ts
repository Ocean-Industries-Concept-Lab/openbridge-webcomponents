...
@customElement('obi-diesel-engine-static')
export class ObiDieselEngineStatic extends LitElement {
  @property({type: Boolean}) useCssColor = false;

  private icon = svg`<svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
<g clip-path="url(#clip0_11002_2648)">
...
<path d="M19 16H14.0133V7H19V8.5H15.769V10.5672H18.7805V12.0672H15.769V14.4874H19V16Z" style="fill: var(--automation-device-secondary-color)"/>
...
declare global {
  interface HTMLElementTagNameMap {
    'obi-diesel-engine-static': ObiDieselEngineStatic;
  }
}
