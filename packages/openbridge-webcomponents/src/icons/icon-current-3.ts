...
@customElement('obi-current-3')
export class ObiCurrent3 extends LitElement {
  @property({type: Boolean}) useCssColor = false;

  private icon = svg`<svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
<path d="M11 18L11 24L13 24L13 18L11 18Z" fill="currentColor"/>
...
<path d="M11 18L11 24L13 24L13 18L11 18Z" style="fill: var(--element-active-color)"/>
