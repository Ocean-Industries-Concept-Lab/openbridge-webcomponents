...
@customElement('obi-in-progress-1')
export class ObiInProgress1 extends LitElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'obi-in-progress-1': ObiInProgress1;
  }
}
