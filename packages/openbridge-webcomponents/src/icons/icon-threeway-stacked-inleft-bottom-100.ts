...
@customElement('obi-threeway-stacked-inleft-bottom-100')
export class ObiThreewayStackedInleftBottom100 extends LitElement {
  @property({type: Boolean}) useCssColor = false;

  private icon = svg`<svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
<g clip-path="url(#clip0_3597_2135)">
<path fill-rule="evenodd" clip-rule="evenodd" d="M13 0L13 10H14L20.47 5.95625C21.136 5.53997 22 6.01881 22 6.80425L22 17.1958C22 17.9812 21.136 18.46 20.47 18.0438L14 14L18.0438 20.47C18.46 21.136 17.9812 22 17.1958 22H6.80425C6.01881 22 5.53997 21.136 5.95625 20.47L10 14L10 10.5C10 10.2239 10.2239 10 10.5 10H11L11 0L13 0ZM14 11C14.1874 11 14.3711 10.9473 14.53 10.848L21 6.80425L21 17.1958L14.53 13.152C14.1351 12.9052 13.6222 12.9636 13.2929 13.2929C12.9636 13.6222 12.9052 14.1351 13.152 14.53L17.1958 21H6.80425L10.848 14.53C10.9473 14.3711 11 14.1874 11 14V11H14Z" fill="currentColor"/>
...
<g clip-path="url(#clip0_3597_2135)">
<path fill-rule="evenodd" clip-rule="evenodd" d="M13 0L13 10H14L20.47 5.95625C21.136 5.53997 22 6.01881 22 6.80425L22 17.1958C22 17.9812 21.136 18.46 20.47 18.0438L14 14L18.0438 20.47C18.46 21.136 17.9812 22 17.1958 22H6.80425C6.01881 22 5.53997 21.136 5.95625 20.47L10 14L10 10.5C10 10.2239 10.2239 10 10.5 10H11L11 0L13 0ZM14 11C14.1874 11 14.3711 10.9473 14.53 10.848L21 6.80425L21 17.1958L14.53 13.152C14.1351 12.9052 13.6222 12.9636 13.2929 13.2929C12.9636 13.6222 12.9052 14.1351 13.152 14.53L17.1958 21H6.80425L10.848 14.53C10.9473 14.3711 11 14.1874 11 14V11H14Z" style="fill: var(--automation-device-tertiary-color)"/>
...
declare global {
  interface HTMLElementTagNameMap {
    'obi-threeway-stacked-inleft-bottom-100': ObiThreewayStackedInleftBottom100;
  }
}
