...
@customElement('obi-clipboard-2')
export class ObiClipboard2 extends LitElement {
...
<path d="M7 11H17V13H7V11Z" style="fill: var(--element-active-color)"/>
<path d="M7 15H14V17H7V15Z" style="fill: var(--element-active-color)"/>
</svg>
`;
