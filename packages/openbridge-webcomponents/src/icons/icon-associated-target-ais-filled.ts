...
@customElement('obi-associated-target-ais-filled')
export class ObiAssociatedTargetAisFilled extends LitElement {
...
<circle cx="12" cy="12" r="11" style="fill: var(--element-active-inverted-color)"/>
...
declare global {
  interface HTMLElementTagNameMap {
    'obi-associated-target-ais-filled': ObiAssociatedTargetAisFilled;
  }
}
