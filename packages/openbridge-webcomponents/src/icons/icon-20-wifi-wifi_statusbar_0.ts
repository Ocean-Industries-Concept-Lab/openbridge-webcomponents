...
@customElement('obi-20-wifi-wifi_statusbar_0')
export class Obi20WifiWifi_statusbar_0 extends LitElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'obi-20-wifi-wifi_statusbar_0': Obi20WifiWifi_statusbar_0;
  }
}
