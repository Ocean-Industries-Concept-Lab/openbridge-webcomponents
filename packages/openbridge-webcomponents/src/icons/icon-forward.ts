...
@customElement('obi-forward')
export class ObiForward extends LitElement {
...
<path d="M6.5 4.86182V19.1386L18.9922 12.0002L6.5 4.86182Z" style="fill: var(--automation-device-primary-color)"/>
</svg>
`;
