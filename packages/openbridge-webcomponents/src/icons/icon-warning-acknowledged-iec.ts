...
@customElement('obi-warning-acknowledged-iec')
export class ObiWarningAcknowledgedIec extends LitElement {
...
<path d="M12 2.5C17.2467 2.5 21.5 6.75329 21.5 12C21.5 17.2467 17.2467 21.5 12 21.5C6.75329 21.5 2.5 17.2467 2.5 12C2.5 6.75329 6.75329 2.5 12 2.5Z" stroke="#DC7100"/>
...
declare global {
  interface HTMLElementTagNameMap {
    'obi-warning-acknowledged-iec': ObiWarningAcknowledgedIec;
  }
}
