...
@customElement('obi-connection-2-bars-caution')
export class ObiConnection2BarsCaution extends LitElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'obi-connection-2-bars-caution': ObiConnection2BarsCaution;
  }
}
