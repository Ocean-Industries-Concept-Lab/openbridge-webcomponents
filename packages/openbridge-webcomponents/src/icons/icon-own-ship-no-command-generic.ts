...
@customElement('obi-own-ship-no-command-generic')
export class ObiOwnShipNoCommandGeneric extends LitElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'obi-own-ship-no-command-generic': ObiOwnShipNoCommandGeneric;
  }
}
