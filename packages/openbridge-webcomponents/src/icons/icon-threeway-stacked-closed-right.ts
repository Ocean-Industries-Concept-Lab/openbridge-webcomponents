...
@customElement('obi-threeway-stacked-closed-right')
export class ObiThreewayStackedClosedRight extends LitElement {
  @property({type: Boolean}) useCssColor = false;

  private icon = svg`<svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
<g clip-path="url(#clip0_3597_1828)">
...
declare global {
  interface HTMLElementTagNameMap {
    'obi-threeway-stacked-closed-right': ObiThreewayStackedClosedRight;
  }
}
