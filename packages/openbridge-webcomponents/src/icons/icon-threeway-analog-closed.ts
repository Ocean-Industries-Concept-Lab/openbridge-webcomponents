...
@customElement('obi-threeway-analog-closed')
export class ObiThreewayAnalogClosed extends LitElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'obi-threeway-analog-closed': ObiThreewayAnalogClosed;
  }
}
