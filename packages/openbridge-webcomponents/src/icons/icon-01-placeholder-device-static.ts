...
@customElement('obi-01-placeholder-device-static')
export class Obi01PlaceholderDeviceStatic extends LitElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'obi-01-placeholder-device-static': Obi01PlaceholderDeviceStatic;
  }
}
