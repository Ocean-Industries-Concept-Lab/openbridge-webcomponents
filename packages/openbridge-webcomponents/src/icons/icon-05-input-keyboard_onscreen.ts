...
@customElement('obi-05-input-keyboard_onscreen')
export class Obi05InputKeyboard_onscreen extends LitElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'obi-05-input-keyboard_onscreen': Obi05InputKeyboard_onscreen;
  }
}
