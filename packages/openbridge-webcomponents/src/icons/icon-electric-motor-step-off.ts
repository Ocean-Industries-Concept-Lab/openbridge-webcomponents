...
@customElement('obi-electric-motor-step-off')
export class ObiElectricMotorStepOff extends LitElement {
  @property({type: Boolean}) useCssColor = false;

  private icon = svg`<svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
<g clip-path="url(#clip0_11002_2620)">
...
<g clip-path="url(#clip0_11002_2620)">
<path d="M12 1C18.0751 1 23 5.92487 23 12C23 18.0751 18.0751 23 12 23C5.92487 23 1 18.0751 1 12C1 5.92487 5.92487 1 12 1Z" style="fill: var(--automation-device-primary-inverted-color)"/>
...
<path d="M17 15.9459V18.7838H8.66667V20H7V17.1622H15.3333V15.9459H17Z" style="fill: var(--automation-device-tertiary-inverted-color)"/>
</g>
<defs>
<clipPath id="clip0_11002_2620">
...
declare global {
  interface HTMLElementTagNameMap {
    'obi-electric-motor-step-off': ObiElectricMotorStepOff;
  }
}
