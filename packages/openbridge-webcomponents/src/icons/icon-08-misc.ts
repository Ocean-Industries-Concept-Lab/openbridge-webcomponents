...
@customElement('obi-08-misc')
export class Obi08Misc extends LitElement {
  @property({type: Boolean, attribute: 'use-css-color'}) useCssColor = false;

  private icon = svg`<svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
<path d="M12 2C6.47715 2 2 6.47715 2 12H4.5C4.5 7.85786 7.85786 4.5 12 4.5V2Z" fill="currentColor"/>
<path d="M22 12C22 6.47715 17.5228 2 12 2V4.5C16.1421 4.5 19.5 7.85786 19.5 12H22Z" fill="currentColor"/>
<path d="M12 22C17.5228 22 22 17.5228 22 12H19.5C19.5 16.1421 16.1421 19.5 12 19.5V22Z" fill="currentColor"/>
<path d="M2 12C2 17.5228 6.47715 22 12 22V19.5C7.85786 19.5 4.5 16.1421 4.5 12H2Z" fill="currentColor"/>
...
<path d="M12 2C6.47715 2 2 6.47715 2 12H4.5C4.5 7.85786 7.85786 4.5 12 4.5V2Z" style="fill: var(--element-active-color)"/>
<path d="M22 12C22 6.47715 17.5228 2 12 2V4.5C16.1421 4.5 19.5 7.85786 19.5 12H22Z" style="fill: var(--element-active-color)"/>
<path d="M12 22C17.5228 22 22 17.5228 22 12H19.5C19.5 16.1421 16.1421 19.5 12 19.5V22Z" style="fill: var(--element-active-color)"/>
<path d="M2 12C2 17.5228 6.47715 22 12 22V19.5C7.85786 19.5 4.5 16.1421 4.5 12H2Z" style="fill: var(--element-active-color)"/>
