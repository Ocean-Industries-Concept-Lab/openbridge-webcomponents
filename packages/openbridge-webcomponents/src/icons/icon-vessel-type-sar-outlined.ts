...
@customElement('obi-vessel-type-sar-outlined')
export class ObiVesselTypeSarOutlined extends LitElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'obi-vessel-type-sar-outlined': ObiVesselTypeSarOutlined;
  }
}
