...
<path d="M11 3H3V5H11V3Z" style="fill: var(--undefined)"/>
<path d="M3 7L11 7V9H3V7Z" style="fill: var(--undefined)"/>
<path d="M21 15H13V17H21V15Z" style="fill: var(--undefined)"/>
<path d="M21 19H13V21H21V19Z" style="fill: var(--undefined)"/>
<path fill-rule="evenodd" clip-rule="evenodd" d="M1 0C0.447715 0 0 0.447716 0 1L0 23C0 23.5523 0.447716 24 1 24H23C23.5523 24 24 23.5523 24 23V1C24 0.447715 23.5523 0 23 0H1ZM22.2929 1H1V22.2929L22.2929 1ZM23 23H1.70711L23 1.70711V23Z" style="fill: var(--undefined)"/>
</svg>
`;
