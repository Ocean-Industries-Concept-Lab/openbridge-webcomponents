...
@customElement('obi-vessel-type-fishing-colour')
export class ObiVesselTypeFishingColour extends LitElement {
  @property({type: Boolean}) useCssColor = false;

  private icon = svg`<svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
<path d="M12 1.53027C15.2914 2.70147 17.4999 5.81861 17.5 9.32422V21.5H6.5V9.32422C6.50014 5.81861 8.7086 2.70147 12 1.53027Z" fill="currentColor" stroke="currentColor"/>
...
<path d="M12 1.53027C15.2914 2.70147 17.4999 5.81861 17.5 9.32422V21.5H6.5V9.32422C6.50014 5.81861 8.7086 2.70147 12 1.53027Z" style="fill: var(--base-categorical-100); stroke: var(--base-categorical-600)"/>
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M6 9.32455V22H18V9.32455C18 5.54759 15.5831 2.19438 12 1C8.41686 2.19438 6 5.54759 6 9.32455ZM16.5 9.32455V20.5H7.5V9.32455C7.5 6.36296 9.2924 3.71562 12 2.59958C14.7076 3.71562 16.5 6.36296 16.5 9.32455Z" style="fill: var(--base-categorical-600)"/>
</svg>
`;
...
declare global {
  interface HTMLElementTagNameMap {
    'obi-vessel-type-fishing-colour': ObiVesselTypeFishingColour;
  }
}
