...
@customElement('obi-mosfet-ptype-4-off')
export class ObiMosfetPtype4Off extends LitElement {
...
<path d="M23 1L13 1V6.25L23 6.25V1Z" style="fill: var(--automation-device-primary-inverted-color)"/>
<path d="M1 1L11 1V6.25L7 6.25L7 3L1 7L1 1Z" style="fill: var(--automation-device-primary-inverted-color)"/>
<path d="M1 7L7 11L7 7.75L11 7.75L11 23H1L1 7Z" style="fill: var(--automation-device-primary-inverted-color)"/>
<path d="M23 23H13V17.75L23 17.75V23Z" style="fill: var(--automation-device-primary-inverted-color)"/>
<path d="M23 7.75L23 16.25L13 16.25V7.75L23 7.75Z" style="fill: var(--automation-device-primary-inverted-color)"/>
...
declare global {
  interface HTMLElementTagNameMap {
    'obi-mosfet-ptype-4-off': ObiMosfetPtype4Off;
  }
}