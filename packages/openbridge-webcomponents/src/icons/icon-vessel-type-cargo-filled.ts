...
@customElement('obi-vessel-type-cargo-filled')
export class ObiVesselTypeCargoFilled extends LitElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'obi-vessel-type-cargo-filled': ObiVesselTypeCargoFilled;
  }
}
