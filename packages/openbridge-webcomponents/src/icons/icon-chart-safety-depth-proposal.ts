...
@customElement('obi-chart-safety-depth-proposal')
export class ObiChartSafetyDepthProposal extends LitElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'obi-chart-safety-depth-proposal': ObiChartSafetyDepthProposal;
  }
}