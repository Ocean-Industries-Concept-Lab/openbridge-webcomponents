...
@customElement('obi-own-ship-simplified-filled')
export class ObiOwnShipSimplifiedFilled extends LitElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'obi-own-ship-simplified-filled': ObiOwnShipSimplifiedFilled;
  }
}
