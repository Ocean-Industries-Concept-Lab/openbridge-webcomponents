...
@customElement('obi-08-motor-off-vertical')
export class Obi08MotorOffVertical extends LitElement {
...
<path d="M21.5 6.5C20.6716 6.5 20 7.17157 20 8V16C20 16.8284 20.6716 17.5 21.5 17.5C22.3284 17.5 23 16.8284 23 16V8C23 7.17157 22.3284 6.5 21.5 6.5Z" style="fill: var(--automation-device-tertiary-inverted-color)"/>
<path d="M2.5 6.5C1.67157 6.5 1 7.17157 1 8L1 16C1 16.8284 1.67157 17.5 2.5 17.5C3.32843 17.5 4 16.8284 4 16L4 8C4 7.17157 3.32843 6.5 2.5 6.5Z" style="fill: var(--automation-device-tertiary-inverted-color)"/>
...
<path d="M6 8V16C6 16.5523 6.44772 17 7 17H17C17.5523 17 18 16.5523 18 16V8C18 7.44771 17.5523 7 17 7L7 7C6.44771 7 6 7.44772 6 8Z" style="fill: var(--automation-device-primary-inverted-color)"/>
<path d="M12 23C10.8954 23 10 22.1046 10 21H14C14 22.1046 13.1046 23 12 23Z" style="fill: var(--automation-device-primary-inverted-color)"/>
<path d="M8 19L8 18H16V19C16 19.5523 15.5523 20 15 20H9C8.44772 20 8 19.5523 8 19Z" style="fill: var(--automation-device-primary-inverted-color)"/>
<path d="M8 3V6L16 6V3C16 2.44772 15.5523 2 15 2L9 2C8.44771 2 8 2.44772 8 3Z" style="fill: var(--automation-device-primary-inverted-color)"/>
<path d="M21 16V8C21 7.72386 21.2239 7.5 21.5 7.5C21.7761 7.5 22 7.72386 22 8V16C22 16.2761 21.7761 16.5 21.5 16.5C21.2239 16.5 21 16.2761 21 16Z" style="fill: var(--automation-device-primary-inverted-color)"/>
<path d="M2 16L2 8C2 7.72386 2.22386 7.5 2.5 7.5C2.77614 7.5 3 7.72386 3 8L3 16C3 16.2761 2.77614 16.5 2.5 16.5C2.22386 16.5 2 16.2761 2 16Z" style="fill: var(--automation-device-primary-inverted-color)"/>
</svg>
`;
...
declare global {
  interface HTMLElementTagNameMap {
    'obi-08-motor-off-vertical': Obi08MotorOffVertical;
  }
}