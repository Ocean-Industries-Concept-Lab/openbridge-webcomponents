...
@customElement('obi-caution-color-iec')
export class ObiCautionColorIec extends LitElement {
...
<path d="M11 14V6H13V14H11Z" style="fill: var(--on-caution-color)"/>
<path d="M13 16H11V18H13V16Z" style="fill: var(--on-caution-color)"/>
</svg>
`;
...
declare global {
  interface HTMLElementTagNameMap {
    'obi-caution-color-iec': ObiCautionColorIec;
  }
}