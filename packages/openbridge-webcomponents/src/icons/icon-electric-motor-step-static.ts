...
@customElement('obi-electric-motor-step-static')
export class ObiElectricMotorStepStatic extends LitElement {
  @property({type: Boolean}) useCssColor = false;

  private icon = svg`<svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
<g clip-path="url(#clip0_11002_2621)">
...
<path d="M17 15.9459V18.7838H8.66667V20H7V17.1622H15.3333V15.9459H17Z" style="fill: var(--automation-device-secondary-color)"/>
</g>
<defs>
<clipPath id="clip0_11002_2621">
...
declare global {
  interface HTMLElementTagNameMap {
    'obi-electric-motor-step-static': ObiElectricMotorStepStatic;
  }
}
