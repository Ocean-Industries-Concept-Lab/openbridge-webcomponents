...
@customElement('obi-vessel-type-cargo-outlined')
export class ObiVesselTypeCargoOutlined extends LitElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'obi-vessel-type-cargo-outlined': ObiVesselTypeCargoOutlined;
  }
}
