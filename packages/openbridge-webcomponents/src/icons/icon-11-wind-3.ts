...
@customElement('obi-11-wind-3')
export class Obi11Wind3 extends LitElement {
...
<path d="M3 8H4V11H3V8Z" style="fill: var(--element-active-color)"/>
</svg>
`;
