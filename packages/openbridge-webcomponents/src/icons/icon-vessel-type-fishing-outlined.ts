...
@customElement('obi-vessel-type-fishing-outlined')
export class ObiVesselTypeFishingOutlined extends LitElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'obi-vessel-type-fishing-outlined': ObiVesselTypeFishingOutlined;
  }
}
