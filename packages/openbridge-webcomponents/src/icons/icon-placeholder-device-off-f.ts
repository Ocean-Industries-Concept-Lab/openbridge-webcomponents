...
@customElement('obi-placeholder-device-off-f')
export class ObiPlaceholderDeviceOffF extends LitElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'obi-placeholder-device-off-f': ObiPlaceholderDeviceOffF;
  }
}