...
@customElement('obi-vessel-type-small-craft-outlined')
export class ObiVesselTypeSmallCraftOutlined extends LitElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'obi-vessel-type-small-craft-outlined': ObiVesselTypeSmallCraftOutlined;
  }
}
