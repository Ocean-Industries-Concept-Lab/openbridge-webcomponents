...
@customElement('obi-chevron-double-left-google')
export class ObiChevronDoubleLeftGoogle extends LitElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'obi-chevron-double-left-google': ObiChevronDoubleLeftGoogle;
  }
}