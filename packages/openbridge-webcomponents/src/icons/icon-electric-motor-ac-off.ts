...
@customElement('obi-electric-motor-ac-off')
export class ObiElectricMotorAcOff extends LitElement {
  @property({type: Boolean}) useCssColor = false;

  private icon = svg`<svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
<g clip-path="url(#clip0_11002_2614)">
...
declare global {
  interface HTMLElementTagNameMap {
    'obi-electric-motor-ac-off': ObiElectricMotorAcOff;
  }
}
