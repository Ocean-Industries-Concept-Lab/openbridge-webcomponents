...
@customElement('obi-chevron-double-right-google')
export class ObiChevronDoubleRightGoogle extends LitElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'obi-chevron-double-right-google': ObiChevronDoubleRightGoogle;
  }
}