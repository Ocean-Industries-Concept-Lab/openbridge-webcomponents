...
@customElement('obi-logic-02')
export class ObiLogic02 extends LitElement {
...
<path d="M6.14881 14.408L10.1568 12.764L6.14881 10.904V9.5L11.9688 12.404V13.244L6.14881 15.812L6.14881 14.408Z" style="fill: var(--automation-device-secondary-color)"/>
...
<path d="M6.15 16L12 16L12 17H6.15V16Z" style="fill: var(--automation-device-secondary-color)"/>
</svg>
`;
