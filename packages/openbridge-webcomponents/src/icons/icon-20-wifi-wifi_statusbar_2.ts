...
@customElement('obi-20-wifi-wifi_statusbar_2')
export class Obi20WifiWifi_statusbar_2 extends LitElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'obi-20-wifi-wifi_statusbar_2': Obi20WifiWifi_statusbar_2;
  }
}
