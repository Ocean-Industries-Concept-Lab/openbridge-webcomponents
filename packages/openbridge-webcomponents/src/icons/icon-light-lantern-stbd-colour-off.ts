...
<path d="M8 20H20V2H22V21C22 21.5523 21.5523 22 21 22H8V20Z" style="fill: var(--automation-device-tertiary-inverted-color)"/>
<rect width="6" height="8" transform="matrix(-1 0 0 1 16 8)" style="fill: var(--automation-device-primary-inverted-color)"/>
</svg>
`;
