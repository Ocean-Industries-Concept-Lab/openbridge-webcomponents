...
@customElement('obi-vessel-type-motor-boat-outlined')
export class ObiVesselTypeMotorBoatOutlined extends LitElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'obi-vessel-type-motor-boat-outlined': ObiVesselTypeMotorBoatOutlined;
  }
}
