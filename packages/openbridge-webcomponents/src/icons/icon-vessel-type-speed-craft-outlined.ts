...
@customElement('obi-vessel-type-speed-craft-outlined')
export class ObiVesselTypeSpeedCraftOutlined extends LitElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'obi-vessel-type-speed-craft-outlined': ObiVesselTypeSpeedCraftOutlined;
  }
}
