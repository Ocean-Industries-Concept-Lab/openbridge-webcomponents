...
@customElement('obi-bipolar-transistor-02-off')
export class ObiBipolarTransistor02Off extends LitElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'obi-bipolar-transistor-02-off': ObiBipolarTransistor02Off;
  }
}
