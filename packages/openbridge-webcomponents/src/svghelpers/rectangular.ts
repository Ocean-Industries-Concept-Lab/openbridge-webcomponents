...
export function rect(id: string, data: { width: number, height: number, strokeWidth: number, strokeColor: string, fillColor: string, borderRadius: number, strokePosition: 'inside' | 'outside' }) {
