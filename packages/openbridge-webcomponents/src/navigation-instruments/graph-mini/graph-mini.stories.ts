...
const meta: Meta<typeof ObcGraphMini> = {
  ...
  args: {
    data: [Array.from({ length: 30 }, (_, i) => i), Array.from({ length: 30 }, (_, i) => Math.sin(i / 30 * 2 * Math.PI))]
  },
...
export const Realtime: Story = {
  tags: ['skip-snapshot'],
  args: {
    data: [Array.from({ length: 60 }, (_, i) => i), Array.from({ length: 60 }, (_, i) => Math.sin(i / 60 * 2 * Math.PI))]
  },
