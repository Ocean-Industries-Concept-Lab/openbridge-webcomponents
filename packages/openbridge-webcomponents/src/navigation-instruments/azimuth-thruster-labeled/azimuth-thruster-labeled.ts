...
export class ObcAzimuthThrusterLabeled extends LitElement {
  ...
  override render() {
    ...
    const azimuthSize = this.size === AzimuthThrusterLabeledSize.large ? Size.large : Size.medium;
    ...
    return html`
      <div class=${classMap({wrapper: true, [this.size]: true})}>
        ...
        <obc-instrument-field class='instrument-field-angle' value=${this.angle} setpoint=${ifDefined(this.angleSetpoint)} tag="Angle" unit='' degree has-setpoint size=${fieldSize}></obc-instrument-field>
        <obc-instrument-field class='instrument-field-power' value=${this.thrust} setpoint=${ifDefined(this.thrustSetpoint)} tag="Power" unit='%' has-setpoint size=${fieldSize}></obc-instrument-field>
        <obc-azimuth-thruster class='azimuth-thruster' no-padding .size=${azimuthSize} .thrust=${this.thrust} .thrustSetpoint=${this.thrustSetpoint} .angle=${this.angle} .angleSetpoint=${this.angleSetpoint} .atThrustSetpoint=${this.atThrustSetpoint} .atAngleSetpoint=${this.atAngleSetpoint}></obc-azimuth-thruster>
      </div>
      `
  }
