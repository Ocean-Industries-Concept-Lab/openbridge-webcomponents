    ...
    return svg`
      <svg viewBox="-256 -256 512 512" xmlns="http://www.w3.org/2000/svg">
        ...
        <g transform="rotate(${this.angleSetpoint})">
          ...
          <path d="M31.5661 81.248L32.0003 82.0078L32.4344 81.248L46.7243 56.2403C47.6767 54.5737 46.4733 52.5 44.5537 52.5L19.4468 52.5C17.5273 52.5 16.3239 54.5737 17.2762 56.2403L31.5661 81.248Z" stroke="var(--border-silhouette-color)"/>
          </svg>
        </g>
