...
const SAMPLE_DATA = [
  ...
  {label: 'Sector C', value: 60},
  {label: 'Sector D', value: 80},
  {label: 'Sector E', value: 60},
  {label: 'Sector E', value: 93},
  {label: 'Sector E', value: 100},
];

const meta: Meta = {
  title: 'Bars and Graphs/Polar chart (using Chart.js)',
