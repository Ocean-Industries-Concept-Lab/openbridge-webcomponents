 ...
 * @property focusable - Whether the button is in the tab sequence. Set it to false for a button
 *   inside a composite widget that owns its own tab stop, and give that widget a key for the action.
