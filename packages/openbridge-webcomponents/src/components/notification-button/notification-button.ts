...
/**
 * `<obc-notification-button>` – A compact action button for notification-related commands or acknowledgments.
 *
 ...
 *
 * ### Usage Guidelines
 * Use `obc-notification-button` for actions directly related to notifications, alerts, or quick status changes. It is ideal for scenarios where space is limited and a compact, easily recognizable action is needed—such as in notification trays, alert banners, or grouped with other quick-action buttons.
 *
 ...
 *
 * <obc-notification-button>ACK</obc-notification-button>
 * ```
 *
