...
const meta: Meta<typeof ObcRichButton> = {
  ...
  render: (args) => html`<obc-rich-button position=${args.position}>
    <obi-01-placeholder slot="leading-icon"></obi-01-placeholder>
    <div slot="label">Title</div>
    <div slot="description">Description with multiple lines of text and more than one line of description</div>
