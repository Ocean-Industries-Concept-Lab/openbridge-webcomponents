...
export class ObcRichButton extends LitElement {
  ...
  private leadingIconSlotController: SlotController = new SlotController(this, 'leading-icon');
  private trailingIconSlotController: SlotController = new SlotController(this, 'trailing-icon');
  private graphicSlotController: SlotController = new SlotController(this, 'graphic');
  private statusSlotController: SlotController = new SlotController(this, 'status');
  private actionSlotController: SlotController = new SlotController(this, 'action');
  ...
  override render() {
    ...
    return html`
      ...
      info: this.info,
      border: this.border,
      'has-leading-icon': this.leadingIconSlotController.hasAssignedElements,
      'has-trailing-icon': this.trailingIconSlotController.hasAssignedElements,
