import {LitElement, TemplateResult, css, html, nothing, svg, unsafeCSS} from 'lit';
...
export class ObcBatteryIcon extends LitElement {
  ...
  override render() {
    ...
    } else if (this.notification) {extraPath = svg`<path d="M16 11H18V18H16V11Z" fill="currentColor"/>
