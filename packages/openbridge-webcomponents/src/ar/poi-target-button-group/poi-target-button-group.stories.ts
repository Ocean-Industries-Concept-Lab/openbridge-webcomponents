...
export const GroupWithTopOffsetTransition: Story = {
  ...
  render: () => {
    return html`
      <style>
        #top-grp-target-1 { left: calc(50% - 15px); }
        #top-grp-target-2 { left: 50%; }
        #top-grp-target-3 { left: calc(50% + 15px); }
      </style>
      <div style="position: absolute; top: 0; left: 0; right: 0; bottom: 0;">
        <obc-poi-target-button-group
          style="position: absolute; top: 0; left: 0;"
        ...
        >
          ...
          <obc-poi-target id="top-grp-target-2" style="position: absolute; top: 50%;" .height=${200}></obc-poi-target>
        </obc-poi-target-button-group>
      </div>
    `;
  },
