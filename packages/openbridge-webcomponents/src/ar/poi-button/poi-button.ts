...
import {ObcPoiHeaderType} from '../building-blocks/poi-header/poi-header.js';
import {
  ObcPoiObjectState,
  ObcPoiObjectStyle,
  ObcPoiObjectType,
...
} from '../building-blocks/poi-selection-frame/poi-selection-frame.js';
import '../building-blocks/poi-selection-frame/poi-selection-frame.js';
