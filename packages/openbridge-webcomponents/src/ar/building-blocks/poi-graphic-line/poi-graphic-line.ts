...
export type POIStyleVariant = Exclude<
  POIStyle,
  POIStyle.Normal | POIStyle.Enhanced
>;

const BASE_COLOR_STYLE = {
  lineColor:
    'var(--obc-poi-line-line-color, var(--overlay-element-active-color))',
  outlineColor:
    'var(--obc-poi-line-outline-color, var(--element-disabled-color))',
} satisfies Pick<POILineParams, 'lineColor' | 'outlineColor'>;
...
const DASHED_DEFAULTS = {
  dashArray: 'var(--obc-poi-line-current-dash-array, 1 3)',
  dashOffset: 0,
  strokeLinecap: 'butt',
...
const ROUTE_DASHED_STYLE: POILineParams = {
  ...
  lineWidth: 1,
  outlineWidth: 2,
  dashArray: 'var(--obc-poi-line-current-dash-array, 4 3)',
  dashOffset: 0,
  strokeLinecap: 'butt',
};
