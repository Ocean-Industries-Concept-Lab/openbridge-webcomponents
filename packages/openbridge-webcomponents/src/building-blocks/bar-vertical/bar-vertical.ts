 ...
 * @property reverse - Reverse the scale so `minValue` is at the top and values grow downward.
 *   Use for quantities measured downward (depth) so they can be plotted with positive numbers.
