...
3. **JIP Members:** Members of the [Joint Industry Project](?path=/docs/introduction-join-the-project--docs) can obtain a **commercial license** that permits use before the Change Date without the AGPL obligations. It does not include redistribution under Apache 2.0 before that date.
