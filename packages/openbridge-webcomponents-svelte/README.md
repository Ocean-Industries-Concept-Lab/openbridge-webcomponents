# Openbridge Web Components Svelte
...
This package provides **Svelte wrappers** for the [Openbridge Web Components](https://github.com/Ocean-Industries-Concept-Lab/openbridge-webcomponents-jip/tree/main/packages/openbridge-webcomponents) core library. 

It allows you to use Openbridge components as native Svelte components with full IDE support, props, and event handling, while leveraging the underlying Lit-based web components from `@oicl/openbridge-webcomponents`.
...
4. Import the desired components in your project, for instance:
   ...
   ```html
   <script>
     import ObcTopBar from "@oicl/openbridge-webcomponents-svelte/components/top-bar/ObcTopBar.svelte";
   </script>
   ```
