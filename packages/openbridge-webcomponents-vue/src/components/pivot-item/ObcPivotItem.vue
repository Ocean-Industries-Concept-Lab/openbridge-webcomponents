    ...
    <script setup lang="ts">
      ...
      import '@ocean-industries-concept-lab/openbridge-webcomponents/dist/components/pivot-item/pivot-item.js';
  ...
  let hasRendered = false;
      ...
      const emit = defineEmits<{
        (e: 'selected', payload: CustomEvent<{value: string}>): void
      }>();
      ...
      const render = () => {
        const eventProps = {
    onSelected: (event: CustomEvent<{value: string}>) => emit('selected', event as CustomEvent<{value: string}>)
  };
