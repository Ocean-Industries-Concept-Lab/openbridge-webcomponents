    ...
    <script setup lang="ts">
      ...
      import '@ocean-industries-concept-lab/openbridge-webcomponents/dist/components/dropdown-button/dropdown-button.js';
  ...
  let hasRendered = false;
      ...
      const emit = defineEmits<{
        (e: 'change', payload: ObcDropdownButtonChangeEvent): void
      }>();
