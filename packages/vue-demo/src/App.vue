...
import ObcClock from '@oicl/openbridge-webcomponents-vue/components/clock/ObcClock'
...
import ObcCommandButton from '@oicl/openbridge-webcomponents-vue/components/command-button/ObcCommandButton'
