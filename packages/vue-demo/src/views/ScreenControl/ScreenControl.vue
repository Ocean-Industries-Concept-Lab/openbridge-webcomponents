...
import { useBridgeStore, type Screen } from '@/stores/bridge';
...
const upperScreens = computed(() => bridgeStore.screens.filter(screen => screen.location === 'up'));
const middleScreens = computed(() => bridgeStore.screens.filter(screen => screen.location === 'middle'));
const lowerScreens = computed(() => bridgeStore.screens.filter(screen => screen.location === 'down'));
