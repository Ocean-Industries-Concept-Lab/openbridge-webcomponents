    ...
    <div class="side-panel-card">
      ...
      >
        ...
        <path d="M42 24C42 28.9706 33.9411 33 24 33C14.0589 33 6 28.9706 6 24"
          stroke="var(--instrument-frame-tertiary-color)" />
        <path d="M42 24C42 19.0294 33.9411 15 24 15C14.0589 15 6 19.0294 6 24"
          stroke="var(--instrument-frame-tertiary-color)" />
        <path d="M42 24C42 19.0294 33.9411 15 24 15C14.0589 15 6 19.0294 6 24"
          stroke="var(--instrument-frame-tertiary-color)" />
        <path d="M24 42C28.9706 42 33 33.9411 33 24C33 14.0589 28.9706 6 24 6"
          stroke="var(--instrument-frame-tertiary-color)" />
        <path d="M24 42C19.0294 42 15 33.9411 15 24C15 14.0589 19.0294 6 24 6"
          stroke="var(--instrument-frame-tertiary-color)" />
        <mask id="mask0_127_7735" style="mask-type: luminance" maskUnits="userSpaceOnUse" x="5" y="5" width="38"
          height="38">
        ...
        <circle cx="24" cy="24" r="3" fill="var(--instrument-frame-primary-color)" stroke="var(--element-neutral-color)"
          stroke-width="2" />
      </svg>
