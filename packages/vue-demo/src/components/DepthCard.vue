...
<template>
  <ObcCard class="depth" has-dialog :dialog-time-out-seconds="12000" :dialog-visible-timer-seconds="10000">
    ...
    <div slot="dialog-content" class="dialog-content">
        ...
        <ObcToggleButtonGroup ref="selector" :value="selectedType" :type="ObcToggleButtonOptionType.text" class="toggle-button-group">
            <ObcToggleButtonOption value="echogram" :type="ObcToggleButtonOptionType.text">Echogram</ObcToggleButtonOption>
            <ObcToggleButtonOption value="depth-diagram" :type="ObcToggleButtonOptionType.text">Depth diagram</ObcToggleButtonOption>
