---
applyTo: "packages/openbridge-webcomponents/src/**,!packages/openbridge-webcomponents/src/icons/**,!packages/openbridge-webcomponents/src/generated/**,!packages/openbridge-webcomponents/src/manual-icon/**,packages/vue-demo/src/**,packages/vue-demo/e2e/**"
---

<!-- GENERATED FILE — DO NOT EDIT.
     Source: docs/agents/development-cycle.md
     Regenerate: npm run agents:sync -w packages/openbridge-webcomponents -->

# Development Cycle

[`working-method.md`](../../docs/agents/working-method.md) says how to think before the first
...
([`working-method.md` § History](../../docs/agents/working-method.md)). A new component starts
...
- Compare the cropped baseline with every Figma variant value
  ([`testing-visual.md` § Checking a baseline](../../docs/agents/testing-visual.md)).
...
- Decide whether the point holds against the code and the tracker. A
  ...
  evidence, not adopted ([`working-method.md` § Missing](../../docs/agents/working-method.md)).
